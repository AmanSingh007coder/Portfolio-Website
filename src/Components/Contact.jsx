...
const Contact = () => {
  ...
  return (
    <section
      id="contact"
      className="font-Inter px-10 md:px-20 md:mt-10 md:scroll-mt-55 scroll-mt-23"
    >
...
>
  ...
  className="bg-white hover:bg-gray-200 w-full md:w-3/4 py-3 rounded-2xl text-black shadow-md flex items-center justify-center gap-2"
>

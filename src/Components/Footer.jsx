   ...
   <div className='container grid grid-cols-1 md:grid-cols-2 gap-4'>
    {/* left-side */}
      <div className='left'>
        ...
        <a href="#home" className='bg-gradient-to-r from-blue-500 to-blue-700 
      ...
      {/* right side */}
       <div className='flex w-full md:gap-60 gap-40 items-center justify-center'>
        <div className='flex flex-col gap-1 p-3'>
           ...
           <a href="https://www.linkedin.com/in/aman-kumar-singh-4a6799348/" target="_blank" rel="noopener noreferrer" className='text-zinc-400 hover:text-gray-300'>LinkedIn</a>

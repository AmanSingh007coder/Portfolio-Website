...
const Education = () => {
    ...
    const experiences = [
  {
    ...
    date: "2024 - Present",
    description:
      "Currently pursuing my B.E. in Engineering, with a strong focus on front-end web development and building modern, responsive digital experiences.",
      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold">
            Education <span className="bg-gradient-to-r from-blue-400 to-blue-700 text-transparent bg-clip-text">& Experience</span>
          </h2>
          <p className="text-gray-400 mt-2">
            My journey through education and professional experiences that
            shaped my expertise in front-end development
          </p>
        </div>
          ...
          {experiences.map((exp, index) => (
            <div key={index} className="mb-12 ml-10">
              ...
              <div className="bg-[#0f0f2b] p-6 rounded-xl shadow-md">
                ...
                <p className="text-blue-400 text-sm flex items-center mb-2">
                  {exp.college}

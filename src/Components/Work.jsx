       ...
       <motion.div
         key={index}
          ...
          <div className="p-4 flex justify-between items-center border-pink-100 ">
            ...
            <a href={project.githublink}> <FiGithub className="mr-1 text-sky-600 cursor-pointer" style={{ fontSize: "20px"}} /></a>
               <a href = "#" target="_blank" rel="noopener noreferrer" className="tags cursor-pointer">
              <a href={project.externalLink}><FiExternalLink className="mr-1 text-sky-600" style={{ fontSize: "20px"}} /></a>
              </a>
              </div>
